<nav class="navbar navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="admin.php"><span class="glyphicon glyphicon-user"></span> <?php echo " " . $user['username']; ?> <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                        <?php 
                                $user_id = $user['id'];
